...
import com.weii.admin.web.utils.PayConfigUtil;
...
/**
 * @Author: weics
 * @Date: Created in 22:25 2018/9/6
 * @Description: 支付初始化
 * @Modified By:
 */
@Controller
...
public class PayController extends BaseController {
    ...
    public Object scanPay(HttpServletRequest httpServletRequest , HttpServletResponse httpServletResponse){
...
//        model.addAttribute("payMessage",buildRequest);
        ...
        result.put("payMessage",buildRequest);
